...
pub use ship::{
    ...
    compute_cooling_constant, project_fuel_for_hop, FuelConfig, FuelProjection, ShipAttributes,
    ShipCatalog, ShipLoadout, FUEL_MASS_PER_UNIT_KG, HEAT_CRITICAL, HEAT_NOMINAL, HEAT_OVERHEATED,
};
