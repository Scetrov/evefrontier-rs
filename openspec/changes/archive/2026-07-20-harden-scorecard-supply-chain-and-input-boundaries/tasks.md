...
- [x] 6.1 Register the repository with the OpenSSF Best Practices program and complete an evidence-backed initial questionnaire without overstating unmet criteria.
