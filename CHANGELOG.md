...
## Unreleased
- 2025-11-30 - GitHub Copilot - [docs] - Aligned README.md with current workspace layout: documented all 6 crates (lib, CLI, and 4 Lambda crates), Nx orchestration, spatial indexing, and updated all examples to use real system names
